...
export function GithubIcon({ className = '', size = 18 }: IconProps) {
  return (
    <svg
      ...
      className={`gh-svg ${className}`}
      style={{ overflow: 'visible' }}
    >
      <g className="gh-glyph" style={{ transformOrigin: '50% 50%' }}>
...
export function LinkedinIcon({ className = '', size = 18 }: IconProps) {
  return (
    <svg
      ...
      strokeLinecap="round"
      strokeLinejoin="round"
      className={`li-svg ${className}`}
      style={{ overflow: 'visible' }}
    >
      <path className="li-line" d="M8 11v5" pathLength={1} />
      <path className="li-line" d="M8 8v.01" pathLength={1} />
      <path className="li-line" d="M12 16v-5" pathLength={1} />
      <path className="li-line" d="M16 16v-3a2 2 0 1 0 -4 0" pathLength={1} />
      <path
        className="li-border"
...
export function CodeIcon({ className = '', size = 14 }: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
export function MapPinIcon({ className = '', size = 13 }: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
export function TabletIcon({ className = '', size = 14 }: IconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
